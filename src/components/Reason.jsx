    ...
    <div className="h-screen flex flex-col md:flex-row">
      <div className="md:w-2/3 flex flex-col justify-center items-center md:items-start">
        <motion.div variants={textVariant()}>
          ...
          <h2 className={styles.sectionHeadText}>Why Web Dev?</h2>
        </motion.div>
        ...
        >
         Web development excites me because it lets me bring ideas to life in a way that's both creative and impactful. I enjoy crafting interfaces that are not only visually engaging but also intuitive and user-friendly. It’s fulfilling to build something that people interact with daily and that makes their experience smoother.
        </motion.p>
